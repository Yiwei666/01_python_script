...
# elementDict类似于{'Si': '90', 'B': '10','CaO':'16','SiO2':'16'}，elementDict字典可以通过05 函数 strToDict() 返回。
# elementDict其实就是手动输入的混合体系组成，可能有单质，也可能有化合物，化合物中部分的原子组成可能不存在于atomDict中，因此10函数里通过调用chemicalsSplit来手动输入。
