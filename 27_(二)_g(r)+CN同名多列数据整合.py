...
# 该脚本与27_g(r)+CN不同名多列数据整合脚本的区别是用文件名来给纵坐标命名
# 该脚本在使用之前需要对同名的文件进行重命名
# g(r)[Si,O ]/g(r)[Si,F ]/g(r)[Ca,O ]/g(r)[Ca,F ]/g(r)[O ,O ]/g(r)[Si,Ca]    
# g(r)[Si,O ]/g(r)[Si,F ]/g(r)[Ca,F ]/g(r)[Ca,O ]/g(r)[Si,Ca]  
# g(r)[Si,F ]/g(r)[Si,O ]/g(r)[Ca,F ]/g(r)[Ca,O ]/g(r)[Si,Ca] 


# g(r)[Ca,F ]/g(r)[Ca,O ]/g(r)[O ,O ]/g(r)[Si,Ca]/g(r)[Si,F ]/g(r)[Si,O ]    
# dn(r)[Ca,F ]/dn(r)[Ca,O ]/dn(r)[Si,Ca]/dn(r)[Si,F ]/dn(r)[Si,O ]
...
# dn(r)[Si,O ]1/dn(r)[Si,O ]2/dn(r)[Si,O ]3/dn(r)[Si,O ]4/dn(r)[Si,O ]5
