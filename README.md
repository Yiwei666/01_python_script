...
2. 局域配位结构算法分析
   ...
   - 在方法17中，配位原子9、配位原子5都只会被写入一次，因此9可能会显示为游离配位原子（远离中心原子8或4），中心原子2或者3的局域配位结构中可能会缺失配位原子5。
   - 在方法18中，配位原子6相对于中心原子1和2会分别调整分坐标，使其可视化时分别靠近相应的原子，以便补全结构。因此，配位原子6可能会被写入多次（分布在盒子外），以便补全相应的局域结构。
