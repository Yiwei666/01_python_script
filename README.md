...
2. 要求表格数据结构满足如下格式
         ...
         Distribution  BL(X-O)  ...  Edensity(X-Si)  Electronegativity
Element                         ...                                   
P             -1.2770     1.57  ...           0.096               2.19
Ti            -0.1411     1.79  ...           0.057               1.54
Mg             0.3604     1.99  ...           0.018               1.31
...
2. 新版脚本位于C:\Users\sun78\Desktop\cp2k_model\50_SiV\49_[扩展Beta]单质或化合物或多相混合体系密度计算.py 目录下
```
