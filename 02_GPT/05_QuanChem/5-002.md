...
2. 如今CP2K计算普遍使用MOLOPT基组，但由于Multiwfn未对广义收缩基组优化，使用该基组会导致计算耗时较高。建议使用6-31G*、6-311G**等片段收缩的全电子基组进行GAPW单点计算，以获得NCI分析用的molden文件，能显著降低耗时。此外，全电子基组相比MOLOPT赝势基组还能明确表达内核电子，而NCI分析对基组不敏感，使用6-31G*通常已足够。参考：http://sobereva.com/588
